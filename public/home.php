...
<div class="row">
    <div class="col-lg-7 col-xl-8">
        ...
        <?php if (!$is_logged_in) { ?>
            <!-- Giriş yapmamış kullanıcılar için modal -->
                ...
                <div class="modal-dialog modal-dialog-centered animate__animated animate__bounceIn">
                    <div class="modal-content rounded-3 shadow">
                        ...
                        <div class="modal-footer flex-column border-top-0 pt-0">
                            <a href="<?php echo BASE_URL; ?>public/pages/login.php" class="btn btn-primary w-75 mb-2">Giriş Yap</a>
                            <a href="<?php echo BASE_URL; ?>public/pages/register.php" class="btn btn-outline-secondary w-75">Kayıt Ol</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <?php if (empty($posts)) { ?>
            ...
            <div class="card mb-4 bg-light border-0 text-center shadow-sm">
                <div class="card-body p-5">
                    ...
                    <a href="<?php echo BASE_URL; ?>public/pages/explore.php" class="btn btn-primary">Keşfet'e Git</a>
                </div>
            </div>
        <?php } else { ?>
                        ...
                        ?>
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    <div class="d-flex align-items-center">
                                        <a href="<?php echo BASE_URL.'public/pages/profile.php?user='.htmlspecialchars($user_row['username']); ?>">
                                        ...
                                        <div>
                                            <a href="<?php echo BASE_URL.'public/pages/profile.php?user='.htmlspecialchars($user_row['username']); ?>" class="text-dark fw-bold text-decoration-none d-block"><?php echo htmlspecialchars($user_row['username']); ?></a>
