...
include_once __DIR__.'/../../includes/logic/register.logic.php';
?>
<!DOCTYPE html>
<html lang="tr">
<head>
    ...
    <title>Kayıt Ol - <?php echo htmlspecialchars($brand_name); ?></title>
...
<body>
    <div class="login-card">
        <h2 class="mb-3"><?php echo htmlspecialchars($brand_name); ?>'e Kayıt Olun</h2>
        ...
        <p class="small-text mb-0">Zaten hesabınız var mı? <a href="<?php echo BASE_URL; ?>public/pages/login.php">Şimdi Giriş Yapın</a></p>
    </div>
